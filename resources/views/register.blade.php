                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h4 class="text-primary">Register Masyarakat</h4>
                            </a>
                        </div>
                        <form action="/admin_masyarakat" method="post">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" name="nik" required>
                            ...
                            <div class="form-floating mb-4">
                                <input type="telp" class="form-control" id="floatingtelp" name="telp" required>
                        ...
                        <p class="text-center mb-0"><a href="/login">Sign Up</a></p>
                    </div>
                </div>
            </div>
        </div>
