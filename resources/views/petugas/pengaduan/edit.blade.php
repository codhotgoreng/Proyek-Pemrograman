...
@section('content_petugas')
    <form action="/petugas_pengaduan/{{ $pengaduan->id_pengaduan }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="col-12">
            <div class="bg-light rounded h-100 p-4">
                ...
                <div class="col-md-6 mb-3 mt-3">
                    <div class="m-n2">
                        <a href="/petugas_pengaduan" type="button" class="btn btn-danger m-2">Kembali</a>
