...
@section('content_petugas')
    <form action="/petugas_tanggapan" method="POST">
        @csrf
        @method('post')
                ...
                <div class="bg-light rounded-top p-4 mt-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="tgl_tanggapan" placeholder="tgl_tanggapan"
                            name="tgl_tanggapan" value="{{ old('tgl_tanggapan') }}" max="{{ date('Y-m-d') }}">
                        @error('tgl_tanggapan')
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="tanggapan" placeholder="tanggapan" name="tanggapan">{{ old('tanggapan') }}</textarea>
                        @error('tanggapan')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3 mt-3">
                        <div class="m-n2">
                            <a href="/petugas_tanggapan" type="button" class="btn btn-danger m-2">Kembali</a>
